...
bool ModelClass::Initialize2(ID3D11Device* device, const WCHAR* modelFilename, const WCHAR* textureFilename)
{
	bool result;
...
bool ModelClass::Initialize3(ID3D11Device* device, const WCHAR* modelFilename, const WCHAR* textureFilename)
{
	bool result;
	...
	// Initialize the vertex and index buffers.
	result = InitializeBuffers3(device);
	if (!result)
	{
		return false;
	}
...
bool ModelClass::Initialize4(ID3D11Device* device, const WCHAR* modelFilename, const WCHAR* textureFilename)
{
	bool result;
	...
	// Initialize the vertex and index buffers.
	result = InitializeBuffers4(device);
	if (!result)
	{
		return false;
	}
...
bool ModelClass::InitializeBuffers(ID3D11Device* device)
{
	...
	instances[1].position = XMFLOAT3(0.0f, 0.0f, 6.0f);
...
bool ModelClass::InitializeBuffers2(ID3D11Device* device)
{
	...
	//instances[2].position = XMFLOAT3(-2.5f, -1.5f, 5.0f);
	//instances[3].position = XMFLOAT3(2.5f, -1.5f, 5.0f);
	//instances[4].position = XMFLOAT3(3.5f, -1.5f, 9.0f);
	//instances[5].position = XMFLOAT3(4.5f, -1.5f, 5.0f);
	//instances[6].position = XMFLOAT3(-3.5f, -1.5f, 8.0f);
	//instances[7].position = XMFLOAT3(-4.5f, -1.5f, 5.0f);
	//instances[8].position = XMFLOAT3(-5.5f, -1.5f, 5.0f);
	//instances[9].position = XMFLOAT3(-6.5f, -1.5f, 7.0f);
	...
	for (int i = 0; i < m_instanceCount; i++)
	{
		...
		instances[i].position = XMFLOAT3(x*120, -1970.0f, z*100);
	}
...
bool ModelClass::InitializeBuffers3(ID3D11Device* device)
{
	VertexType* vertices;
	unsigned long* indices;
	D3D11_BUFFER_DESC vertexBufferDesc, indexBufferDesc;
...
bool ModelClass::InitializeBuffers4(ID3D11Device* device)
{
	VertexType* vertices;
	unsigned long* indices;
	D3D11_BUFFER_DESC vertexBufferDesc, indexBufferDesc;
	...
	{ 
		instances[i].position = XMFLOAT3(-200.0f + 50.0 * i, -1970.0f, 0.0f);
	}

	/*instances[0].position = XMFLOAT3(100.0f, -1970.0f, 500.0f);
	instances[1].position = XMFLOAT3(1.5f, -1970.0f, 5.0f);
	instances[2].position = XMFLOAT3(-2.5f, -1970.0f, 5.0f);
	instances[3].position = XMFLOAT3(2.5f, -1970.0f, 5.0f);
	instances[4].position = XMFLOAT3(3.5f, -1970.0f, 9.0f);
	instances[5].position = XMFLOAT3(4.5f, -1970.0f, 5.0f);
	instances[6].position = XMFLOAT3(-3.5f, -1970.0f, 8.0f);
	instances[7].position = XMFLOAT3(-4.5f, -1970.0f, 5.0f);
	instances[8].position = XMFLOAT3(-5.5f, -1970.0f, 5.0f);
	instances[9].position = XMFLOAT3(-6.5f, -1970.0f, 7.0f);*/
